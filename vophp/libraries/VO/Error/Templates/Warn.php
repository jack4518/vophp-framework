...
<body>
	...
	<div class="misinformation_main">
		<div class="misinformation_content">
			<div class="misinformation_title">警告类型：<font color="#FF9933">系统警告！</font></div>
			<div class="misinformation_choose">
				您可以选择 [<a href="" style="cursor:pointer;" onclick="window.reload()">重试</a>] 
				[<a href="" style="cursor:pointer;" style="cursor:pointer;" onclick="window.history.back()">返回</a>] 或者 
			...
			<div class="misinformation_fieldset">
				<fieldset id="misinformation_border">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
						<td>所在文件：</td>
						<td style="color:#FF9933;"><?php echo $file; ?></td>
					  </tr>
					  <?php } ?>
					  <?php if( isset($line) ){?>
					  <tr>
						<td width="80">提示行号：</td>
						<td>第 <font color="#FF9933"><?php echo $line; ?></font> 行</td>
					  </tr>
					  <?php } ?>
					  <tr>
						<td valign="top">警告信息：</td>
						<td style="color:#FF9933;"><?php echo $message; ?></td>
					  </tr>
					</table>
				</fieldset>
			</div>
									...
									<li onclick="toggleCode(this)" style="cursor:pointer;">
										...
										<ul>
											<?php foreach($array['error']['source'] as $le => $line_code){ ?>
												...
												<li style="background:#A9C43C; color:#fff;">
												<?php }else{?>
												<li>
												<?php }?>
